...
<html lang="en">
	...
	<?php
		...
		if (isset($_POST['update'])) 
		{
			...
			$link ->query("UPDATE tbl_farmer SET f_name ='$fname', l_name ='$lname', adress ='$address',payment ="$payment" NIC ='$nic', contact ='$contact' WHERE id = '$id' ") or die($link->error());
			header('location:UserRegistration.php');
		}
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
								...
								<input type="hidden" name="id" id="id" value="<?php echo $id;?>">
                                    ...
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputpayment">register payment</label>
                                        <input class="form-control py-4" id="inputAddress" name="inputAddress" type= value="<?php echo $address; ?>" placeholder="Enter Address" />
                                    </div>
