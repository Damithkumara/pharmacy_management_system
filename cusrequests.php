            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Customer Requests</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputFaIDCardNumber">Customer </label>
                                                <select id="inputState" class="form-control" >
                                                        <option selected>Cargills</option>      
                                                        <option>Keels</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputNumberOfKG" type="text" placeholder="Enter weight" onkeyup="add()" />
                                            </div>
                                        </div>
                                    ...
                                    <!--Batton Save-->
                                    <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" name="submit" type="submit">Issue Order</button>
