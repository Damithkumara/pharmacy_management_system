                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputAddress">ID card No</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputIDCardNumber">ID card No</label>
                                                <input class="form-control py-4" id="inputIDCardNumber" type="text" placeholder="Enter ID card Number" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputContactNumber">Contact number</label>
                                                <input class="form-control py-4" id="inputContactNumber" type="text" placeholder="Enter lContact number" />
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group mt-4 mb-0"><a class="btn btn-primary btn-block" href="login.html">Add User</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
